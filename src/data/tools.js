export const toolCategories = [
  ...
  },
  {
    ...
    color: "#8b5cf6",
    description:
      "AI-powered tools and platforms used to enhance product strategy, automate workflows, generate insights, and build smarter product experiences.",
    tools: ["ChatGPT", "Claude AI", "Midjourney", "GitHub Copilot", "Notion AI", "Google Gemini", "Prompt Engineering", "AI-Driven Analytics"],
  },
  {
    category: "Cloud & DevOps",
    color: "#e11d48",
    description:
      "Familiarity with cloud platforms and deployment workflows that helps bridge the gap between product requirements and engineering execution.",
    tools: ["AWS Basics", "Firebase", "Vercel", "Docker Basics", "CI/CD Pipelines", "Postman"],
  },
];
